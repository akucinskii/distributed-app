defmodule DistributedApiWeb.ItemLive.Index do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:boxes, Boxes.list_boxes() |> Enum.map(&{&1.name, &1.id}))
  ...
  @impl true
  def handle_info({DistributedApiWeb.ItemLive.FormComponent, {:saved, item}}, socket) do
